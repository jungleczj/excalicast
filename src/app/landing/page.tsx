        ...
        <div className="mx-auto max-w-6xl px-6 py-20">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-border-default bg-bg-primary p-8">
              ...
              <Link href="/" className="mt-8 block rounded-md border border-border-strong bg-bg-primary px-5 py-2.5 text-center text-[14px] font-semibold text-text-primary hover:bg-bg-tertiary">
                开始录制
              </Link>
            </div>
            ...
            >
              ...
              <Link href="/" className="mt-8 block rounded-md bg-white px-5 py-2.5 text-center text-[14px] font-semibold text-accent-600 shadow-md hover:bg-bg-secondary">
                录制后即可解锁
              </Link>
            </div>
          </div>
